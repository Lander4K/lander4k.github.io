...
Listando nuevamente binarios con permisos SUID, nos percatamos que el programa `/opt/fixed/new` es SUID y le pertenece al usuario `root`, nos podemos fijar que al ejecutar el archivo y enviar de arguemtno muchos bytes el programa se corrompe
