...
date: 2023-02-25
categories: [Writeup]
tags: [FTP, Python Scripting, LFI, PHP Filter Chains, LFI2RCE, Docker, Chisel, Port Forwarding, Boolean SQL Injection, RSA, Path Hijacking, Sudoers Missconfiguration, Stack Based Buffer Overflow x64]
img_path: /assets/img/commons/otros/hell
pin: 
image:
  path: hell.png
  alt: Hell WriteUp
...
<img src="factordb.png">

Cuando le pasamos `n` lo consigue factorizar y nos devuelve nos números primos que son `p` y `q`
